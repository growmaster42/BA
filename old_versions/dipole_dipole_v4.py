...
def transform_matrix(matrix):
    unity_matrix = np.array([[1, 0, 0], [0, 1, 0], [0, 0, 1]], dtype=complex)
    m, a, b = matrix
    x = m + unity_matrix
...
def dipol_1():
    ...
    for k in range(dim):
        for x in range(dim):
            summand_1 = quarter * orient[0][0, 0] * summand_matrix_entry_distance_1(s_plus_s_plus, vec, k, x)
            summand_2 = quarter * orient[0][0, 1] * summand_matrix_entry_distance_1(s_plus_s_minus, vec, k, x)
            summand_3 = quarter * orient[0][1, 0] * summand_matrix_entry_distance_1(s_minus_s_plus, vec, k, x)
            summand_4 = quarter * orient[0][1, 1] * summand_matrix_entry_distance_1(s_minus_s_minus, vec, k, x)
...
def dipol_2():
    ...
    for k in range(dim):
        for x in range(dim):
            summand_1 = orient[0][0, 0] * quarter_i * summand_matrix_entry_distance_2(s_plus_s_plus, vec, k, x)
            summand_2 = - orient[0][0, 1] * quarter_i * summand_matrix_entry_distance_2(s_plus_s_minus, vec, k, x)
            summand_3 = orient[0][1, 0] * quarter_i * summand_matrix_entry_distance_2(s_minus_s_plus, vec, k, x)
            summand_4 = - orient[0][1, 1] * quarter_i * summand_matrix_entry_distance_2(s_minus_s_minus, vec, k, x)
            # Ersetze dies ggf. durch eine andere Berechnung
            matrix[k, x] += (summand_1 + summand_2 + summand_3 + summand_4)
    # Hier wird die Berechnung in die Matrix geschrieben
    return matrix
...
def dipol_3():
    ...
    for k in range(dim):
        for x in range(dim):
            summand_1 = orient[0][0, 0] * quarter_i * summand_matrix_entry_distance_3(s_plus_s_plus, vec, k, x)
            summand_2 = orient[0][0, 1] * quarter_i * summand_matrix_entry_distance_3(s_plus_s_minus, vec, k, x)
            summand_3 = - orient[0][1, 0] * quarter_i * summand_matrix_entry_distance_3(s_minus_s_plus, vec, k, x)
            summand_4 = - orient[0][1, 1] * quarter_i * summand_matrix_entry_distance_3(s_minus_s_minus, vec, k, x)
            # Ersetze dies ggf. durch eine andere Berechnung
            matrix[k, x] += (summand_1 + summand_2 + summand_3 + summand_4)
    # Hier wird die Berechnung in die Matrix geschrieben
    return matrix
...
def dipol_4():
    ...
    for k in range(dim):
        for x in range(dim):
            summand_1 = - orient[0][0, 0] * quarter * summand_matrix_entry_distance_4(s_plus_s_plus, vec, k, x)
            summand_2 = orient[0][0, 1] * quarter * summand_matrix_entry_distance_4(s_plus_s_minus, vec, k, x)
            summand_3 = orient[0][1, 0] * quarter * summand_matrix_entry_distance_4(s_minus_s_plus, vec, k, x)
            summand_4 = -  orient[0][1, 1] * quarter * summand_matrix_entry_distance_4(s_minus_s_minus, vec, k, x)
            # Ersetze dies ggf. durch eine andere Berechnung
            matrix[k, x] += (summand_1 + summand_2 + summand_3 + summand_4)
